...
public class Lugares {
	...
	//Constructor para la clase Lugares, sin parámetros.
    public Lugares() 
    {
    ...
    //Se definen métodos de acceso a las variables(como getters y setters)
	...
	public static ArrayList<Lugar> ejemploLugares() {
          ...
          lugares.add(new Lugar("Escuela Politécnica Superior de Gandía",    //Nombre
        		                "C/ Paranimf, 1 46730 Gandia (SPAIN)",       //Dirección
        		                -0.166093,                                   //Longitud
        		                38.995656,                                   //Latitud
        		                TipoLugar.EDUCACION,                         //Tipo de Lugar
        		                962849300,                                   //Teléfono
        		                "http://www.epsg.upv.es",                    //url
                                "Uno de los mejores lugares para formarse.", //Descripción
                                3));                                         //Valoración
